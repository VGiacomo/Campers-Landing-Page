            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Meet the people next tent
                    </div>
                    <div className="text-gray-600">
                      In the main feed you are instantly connected to your
                      neighbours, say hello and see what happens.
                    </div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Share your thoughts and get inspired
                    </div>
                    <div className="text-gray-600">
                      Ask for some advices on the best trails around. Invite
                      people to share a drink by the fire.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
